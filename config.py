...
BOSS_ATTACK_COOLDOWN_MIN_SECONDS = 3
BOSS_ATTACK_COOLDOWN_MAX_SECONDS = 4
...
BOSS_DEBUFF_ATTACK_COOLDOWN_SECONDS = (8, 12)
BOSS_FROST_PROC_CHANCE = 0.35
BOSS_FROST_SLOW_SECONDS = BOSS_DEBUFF_ATTACK_COOLDOWN_SECONDS
...
BOSS_STORM_STUN_SECONDS = BOSS_DEBUFF_ATTACK_COOLDOWN_SECONDS

BOSS_VOID_DRAIN_PROC_CHANCE = 0.30
BOSS_VOID_MANA_DRAIN = (12, 28)

BOSS_VERDANT_ROOT_PROC_CHANCE = 0.30
BOSS_VERDANT_ROOT_SECONDS = BOSS_DEBUFF_ATTACK_COOLDOWN_SECONDS
