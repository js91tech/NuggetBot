...
def roll_player_damage(
    ...
    *,
    ...
    del attacker_id  # retained for call-site compatibility
...
def apply_armor_mitigation(
    ...
    *,
    ...
    del defender_id  # retained for call-site compatibility
    attr_mitigation_bonus = float(attr_mitigation_bonus)
    if armor is None:
