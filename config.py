...
NOTIFY_BUSINESS = 4
NOTIFY_DEFENSE = 8
NOTIFY_DEFAULT_FLAGS = NOTIFY_CROPS | NOTIFY_BOSS | NOTIFY_BUSINESS | NOTIFY_DEFENSE
NOTIFY_BUSINESS_FILL_PCT = 0.90

# Tier 2 retention — weekly challenges, login calendar, activity pass, referrals
WEEKLY_QUEST_COUNT = 3
CALENDAR_CYCLE_DAYS = 7
CALENDAR_REWARDS: tuple[float, ...] = (50, 75, 100, 150, 200, 300, 500)
CALENDAR_CLAIM_COOLDOWN_SECONDS = 20 * 60 * 60  # once per ~day
CALENDAR_GRACE_SECONDS = 36 * 60 * 60  # miss window resets streak

PASS_TIER_COUNT = 10
PASS_TIER_XP: tuple[int, ...] = (150, 400, 750, 1_200, 1_800, 2_500, 3_400, 4_500, 6_000, 8_000)
PASS_TIER_REWARDS: tuple[float, ...] = (200, 350, 500, 700, 900, 1_200, 1_500, 2_000, 2_750, 4_000)

REFERRAL_REFERRER_REWARD = 1_000.0
