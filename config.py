...
RELIC_MAX_EQUIP = 1
COMPANION_MAX_EQUIP = 3
COMPANION_DROP_CHANCE = 0.12

# Companion combat (auto-attack henchlings)
COMPANION_BASE_STAMINA = 50
COMPANION_STAMINA_PER_STRIKE = 5
COMPANION_STAMINA_REGEN_PER_MINUTE = 1
COMPANION_ATTACK_TICK_SECONDS = 30
COMPANION_OWNER_STAT_INHERIT = 0.25
COMPANION_BASE_DAMAGE = 18
COMPANION_TIER_DAMAGE_STEP = 12
COMPANION_RENAME_COST = 500_000.0
COMPANION_STAMINA_PACK_RESTORE = 25
COMPANION_STAMINA_PACK_PRICE = 2_500_000.0
COMPANION_MAX_EVOLUTION_TIER = 5
COMPANION_EVOLUTION_COSTS: dict[int, float] = {
    2: 100_000.0,
    3: 500_000.0,
    4: 2_000_000.0,
    5: 10_000_000.0,
}
COMPANION_RARITY_DAMAGE_MULT: dict[str, float] = {
    "common": 1.0,
    "uncommon": 1.15,
    "rare": 1.30,
    "epic": 1.50,
}
COMPANION_EVOLUTION_DAMAGE_BONUS: float = 0.15
COMPANION_PET_DUEL_STAMINA_COST = 10
COMPANION_PET_DUEL_MIN_STAKE = 5_000.0
COMPANION_PET_DUEL_MAX_STAKE = 250_000.0
COMPANION_PET_DUEL_COOLDOWN_SECONDS = 300
