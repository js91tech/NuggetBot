...
SCOURGE_HOURLY_TRIGGER_CHANCE = 1.0
SCOURGE_HOURLY_JITTER_SECONDS = (54 * 60, 66 * 60)
...
BOSS_ATTACK_COOLDOWN_SECONDS = 4
...
BOSS_FROST_SLOW_SECONDS = 14
BOSS_FROST_EXTRA_ATTACK_COOLDOWN = 3
...
BOSS_STORM_STUN_SECONDS = (30, 60)

BOSS_VOID_DRAIN_PROC_CHANCE = 0.30
BOSS_VOID_MANA_DRAIN = (12, 28)

BOSS_VERDANT_ROOT_PROC_CHANCE = 0.30
BOSS_VERDANT_ROOT_SECONDS = 10
BOSS_VERDANT_EXTRA_ATTACK_COOLDOWN = 2
